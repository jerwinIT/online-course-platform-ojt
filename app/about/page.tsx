    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="space-y-6 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              We believe education is the most powerful tool for personal and
              professional transformation. Since 2020, we&apos;ve been making
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                courses that empower individuals to achieve their goals and
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Courses accessible in 150+ countries with 50+ languages
                      supported.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Building a supportive community of learners from diverse
                      backgrounds.
                    </p>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <Card
                key={i}
                className="text-center overflow-hidden hover:shadow-lg transition-shadow duration-300"
              >
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Milestones that shaped LearnHub
            </p>
          </div>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center space-y-8">
          ...
          <p className="text-lg text-muted-foreground">
            Start your learning journey today and be part of a global community
