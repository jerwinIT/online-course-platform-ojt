...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // Base & focus
        "focus-visible:border-[#28a745] focus-visible:ring-[#28a745]/50 focus-visible:outline-[#28a745] relative inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-md border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap transition-all focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        // Idle text
        "text-foreground/60 hover:text-[#28a745] dark:text-muted-foreground dark:hover:text-[#28a745]",
        // Layout
        "group-data-[orientation=vertical]/tabs:w-full group-data-[orientation=vertical]/tabs:justify-start",
        // Default variant — active state
        "group-data-[variant=default]/tabs-list:data-[state=active]:shadow-sm",
        "data-[state=active]:bg-background data-[state=active]:text-[#28a745] data-[state=active]:border-[#28a745]/30",
        "dark:data-[state=active]:bg-input/30 dark:data-[state=active]:border-[#28a745]/40 dark:data-[state=active]:text-[#28a745]",
